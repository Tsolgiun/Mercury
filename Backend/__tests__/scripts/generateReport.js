 ...
 * 
 * This script runs the tests and automatically opens the HTML reports
 * It also displays a summary of the results in the console
 */
...
console.log(`${colors.bright}${colors.blue}Mercury Backend Test Report Generator${colors.reset}`);
...
try {
  ...
  const reportPath = resolve(__dirname, '../../test-reports/test-report.html');
